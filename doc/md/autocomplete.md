...
* First step is to install the plugins [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) and [zbirenbaum/copilot-cmp](https://github.com/zbirenbaum/copilot-cmp).

* Then call the setup function for copilot.lua.
...
* Once copilot started, run the command `:Copilot auth` to start the authentication process.

* Add the source in nvim-cmp
